package cs.youtrade.telegram.menu.example.button1;
...
@Component
public class Button1State extends BaseTerminalTextMenuState {
    public Button1State(
    ...
    public ExampleState supportedState() {
        return ExampleState.BUTTON_1;
    }

    @Override
    public String getHeaderText(TelegramClient bot, UserData userData) {
        return "Welcome to the first menu";
    }
}
